...
const saleStateLabels = {
  coming_soon: "販売開始前",
  ended: "販売終了",
  on_sale: "販売中",
  sold_out: "完売",
} as const satisfies Readonly<Record<GachaPresentationState["sale_state"], string>>;
const reasonLabels = {
...
} as const satisfies Readonly<Record<NonNullable<GachaPresentationState["ineligible_reason"]>, string>>;
