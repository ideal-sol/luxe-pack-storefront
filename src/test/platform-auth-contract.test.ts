...
describe("MIG-062J authentication contract regression", () => {
  ...
  it.each([
    ...
    assertBrowserRequestBoundary(harness.mock.requests[0]!, { client_version: "2.0.0-alpha.10", site_version: "0.1.0" });
  ...
  it("registers and logs in using canonical request and response types", async () => {
    ...
    assertBrowserRequestBoundary(login.mock.requests[1]!, { client_version: "2.0.0-alpha.10", site_version: "0.1.0" });
