...
describe("alpha.37 authentication, account security, and SMS contract", () => {
  it("imports the canonical immutable Client, Schema, and Testkit versions", () => {
    for (const [packageName, version] of Object.entries({
      "site-schema": "2.0.0-alpha.23",
      "storefront-client": "2.0.0-alpha.37",
      "storefront-testkit": "2.0.0-alpha.37",
    })) {
  ...
  it("registers and logs in using canonical request and response types", async () => {
    ...
    assertBrowserRequestBoundary(login.mock.requests[1]!, { client_version: "2.0.0-alpha.37", site_version: "0.1.0" });
  ...
  it("uses the canonical SMS status, send, resend, and verify operations", async () => {
    ...
    assertBrowserRequestBoundary(status.mock.requests[0]!, { client_version: "2.0.0-alpha.37", site_version: "0.1.0" });
