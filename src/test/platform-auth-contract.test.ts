...
describe("alpha.40 authentication, account security, and SMS contract", () => {
  ...
  it("registers and logs in using canonical request and response types", async () => {
    ...
    assertBrowserRequestBoundary(login.mock.requests[1]!, { client_version: "2.0.0-alpha.40", site_version: "0.1.0" });
  ...
  it("uses the canonical SMS status, send, resend, and verify operations", async () => {
    ...
    assertBrowserRequestBoundary(status.mock.requests[0]!, { client_version: "2.0.0-alpha.40", site_version: "0.1.0" });
