...
describe("MIG-062V authentication contract regression", () => {
  ...
  it("registers and logs in using canonical request and response types", async () => {
    ...
    assertBrowserRequestBoundary(login.mock.requests[1]!, { client_version: "2.0.0-alpha.19", site_version: "0.1.0" });
