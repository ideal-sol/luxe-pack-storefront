...
describe("MIG-062U public catalog contract regression", () => {
  it("uses the canonical gacha list with category and cursor queries", async () => {
    ...
    assertBrowserRequestBoundary(category.mock.requests[0]!, { client_version: "2.0.0-alpha.18", site_version: "0.1.0" });
