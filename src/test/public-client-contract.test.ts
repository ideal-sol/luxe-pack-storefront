...
describe("MIG-062Z retained public catalog contract", () => {
  it("uses the canonical gacha list with category and cursor queries", async () => {
    ...
    assertBrowserRequestBoundary(category.mock.requests[0]!, { client_version: "2.0.0-alpha.21", site_version: "0.1.0" });
  ...
  it("uses canonical detail and user-specific presentation reads", async () => {
    ...
    assertBrowserRequestBoundary(harness.mock.requests[1]!, { client_version: "2.0.0-alpha.21", site_version: "0.1.0" });
